...
public class Random {
    ...
    public static int Int(int max) {
        return max > 0 ? (int) (MathUtils.random() * max) : 0;
    }

    public static int Int(int min, int max) {
        return min + (int) (MathUtils.random() * (max - min));
    }

    public static int IntRange(int min, int max) {
        return min + (int) (MathUtils.random() * (max - min + 1));
    }

    public static int NormalIntRange(int min, int max) {
        return min + (int) ((MathUtils.random() + MathUtils.random()) * (max - min + 1) / 2f);
    }
    ...
    public static int index(Collection<?> collection) {
        return (int) (MathUtils.random() * collection.size());
    }

    @SafeVarargs
    public static <T> T oneOf(T... array) {
        return array[(int) (MathUtils.random() * array.length)];
    }
    ...
    public static <T> T element(T[] array, int max) {
        return array[(int) (MathUtils.random() * max)];
    }
